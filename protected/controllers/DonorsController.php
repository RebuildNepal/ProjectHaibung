...
class DonorsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Donors']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->DonorID));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Donors');
	 ...
	 * @return Donors the loaded model
	 ...
	 * @param Donors $model the model to be validated
	 */
